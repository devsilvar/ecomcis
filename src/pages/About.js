        ...
        <Wrapper className="lg:grid lg:grid-cols-2 flex flex-col-reverse gap-10">
          ...
          >
            ...
            <p className="leading-relaxed">
              At <span className="uppercase">Amaraé</span>, we believe in the
              power of fashion to transform and empower. Our brand is dedicated
              to providing stylish, high-quality clothing that is accessible to
              women from all walks of life. Founded on the principles of
              inclusivity and empowerment, we celebrate individuality and
              confidence, offering a diverse range of designs that empower women
            ...
            <p className="leading-relaxed">
              ...
              the heart of <span className="uppercase">Amaraé</span> is a
              commitment to our customers, prioritizing their needs and
