        ...
        <Wrapper className="flex flex-col lg:gap-10">
          ...
          <div className="md:grid md:grid-cols-3 flex flex-col gap-4">
            ...
            <article className="md:col-span-2 flex flex-col leading-relaxed gap-4 py-6 lg:px-8">
              ...
              <p>
                Reference in this policy to “Amarae”, “we”, “us”, “our” or any
                similar term is Bespoke by Amarae Limited with RC 7025693 who is
                the data controller.
              </p>
              ...
              <ol className="list-decimal flex flex-col gap-2 list-inside">
                <li id="introduction">
                  ...
                  <ul className="list-disc list-outside pl-8">
                    <li>
                      ...
                      <ul className="list-disc list-outside pl-8">
                        <li>
                          your use of Amarae mobile application software (App)
                          or use of the Amarae website [WEBSITE] (Amarae Site)
                        </li>
                        <li>
                          Any of the services accessible through the App or that
                          are available on the Amarae Site or other sites of
                          ours (together the Services Sites or Sites) (Amarae
                          Services).
                        </li>
                      </ul>
                    </li>
                ...
                <li id="data-collections">
                  ...
                  <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                    <li>
                      Under this Policy, personal data, or personal information,
                      means any information about an individual from which that
                    ...
                    <li>
                      <span>
                        ...
                        of personal data which we have grouped together as
                        follows:
                      </span>

                      <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                        <li>
                          <strong>Identity Data</strong> includes your name,
                          first name, maiden name, last name, username or
                          similar identifier, marital status, title, date of
                          birth and gender.
                        </li>
                        <li>
                          <strong>Contact Data</strong> includes your contact
                          address, email address and telephone numbers.
                        </li>
                        <li>
                          <strong>Financial Data</strong> includes your bank
                          account and payment card details that you input when
                          you use the Amarae Services. If you do not use Amarae,
                          you may opt out of providing this information.
                        </li>
                        <li>
                          <strong>Transaction Data</strong> includes details
                          about payments to and from you and other details of
                          products and services you have purchased from and
                          through us.
                        </li>
                        <li>
                          <strong>Technical Data</strong> includes your internet
                          ...
                          platform, and other technology on the devices you use
                          to access this website.{" "}
                        </li>
                        <li>
                          <strong>Profile Data</strong> includes your username
                          and password, purchases or orders made by you, your
                          interests, preferences, feedback and survey responses.
                        </li>
                        <li>
                          <strong>Usage Data</strong> includes information about
                          how you use the App, website, products and services.
                        </li>
                        <li>
                          <strong>Marketing and Communications Data</strong>{" "}
                          includes your preferences for receiving marketing from
                  ...
                  <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                    ...
                    <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                      <li>
                        ...
                        signing up for an Amarae account or filling in forms on
                        the App, Amarae Site and the Services Sites, or by
                        corresponding with us either by email or chat. It
                        includes but is not limited to information you provide
                        when you register to use the App or Services Sites,
                        download or register to the App, subscribe to any of our
                        Services, search for a Service on the Amarae Site, share
                        data via social media functions, promotion or survey, or
                        other activities commonly carried out in connection with
                        the App, Amarae Sites or Services Sites, and when you
                        report a problem with the App, our Services, or any of
                        our Sites. If you contact us, we will keep a record of
                        that correspondence.{" "}
                      </li>
                      <li>
                        <strong>
                        ...
                        Each time you visit our Services Sites or use our App,
                        we will automatically collect personal data including
                        device, content and usage data. We collect this data
                      ...
                      <li>
                        ...
                        location. Some of our location-enabled Services require
                        your personal data for the feature to work. If you wish
                        to use this particular feature, you will be asked to
                        consent to your data being used for this purpose. You
                        can withdraw your consent at any time by disabling
                        Location Data in your settings or any other way in which
                        consent can be withdrawn.
                      </li>
                      <li>
                        <strong>Transaction information:</strong> We collect
                        transaction information related to the use of our
                        Services, including the type of services requested or
                        provided, order details, delivery information, date and
                        time the Service was provided, amount charged, distance
                        travelled, and payment method. Additionally, if someone
                        uses your promotion code, we may associate your name
                        with that person.
                      </li>
                      <li>
                        <strong>Device data:</strong> We may collect data about
                        the devices used to access our Services, including the
                        hardware models, device IP address, operating systems
                        and versions, software, preferred languages, unique
                        device identifiers, advertising identifiers, serial
                        numbers, device motion data, and mobile network data.
                      </li>
                      <li>
                        <strong>Unique application numbers.</strong> When you
                        want to install or uninstall a Service containing a
                        unique application number or when such a Service
                        searches for automatic updates, that number and
                        information about your installation, for example, the
                        type of operating system, may be sent to us.
                      </li>
                      <li>
                        <strong>
                          Information we receive from other sources including
                    ...
                    <li>
                      Users participating in our referral programs. For example,
                      when a user refers to another person, we receive the
                      referred person’s personal data from that user.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                        <li>
                          When you use the Amarae Services, we collect
                          information provided to us through your computer,
                          mobile phone, or other access device. This includes
                          personal data that you volunteer on forms which you
                          submit to us and in emails that you send to us. In
                          addition, we automatically gather details of browser
                          types and IP addresses of the users who visit our
                          site. We do not release this information to any
                          outside party, except in suspected fraud cases.
                        </li>
                        <li>
                          When you use Amarae, we collect information about your
                          transactions and/or your other activities on our
                          website and we may continuously collect information
                          about your computer, mobile device, or other access
                          device for fraud prevention purposes, to monitor for
                          possible breach of your Amarae Account, and to
                          identify any malicious software or other activity that
                          may harm Amarae or its users.
                        </li>
                        <li>
                          You may choose to provide us with access to certain
                          personal information stored by third parties such as
                          social media sites (such as Facebook and Twitter). The
                          information we have access to varies by site and is
                          controlled by your privacy settings on that site and
                          your authorisation. By associating an account managed
                          by a third party with your Amarae account and
                          authorising Amarae to have access to this information,
                          you agree that Amarae may collect, store, and use this
                          information in accordance with this Privacy Policy.
                        </li>
                        <li>
                          Finally, we may collect additional information you may
                          disclose to our customer support team. When you use
                          Amarae Services, we collect information sent to us
                          through your computer, mobile phone, or other access
                          device. This includes personal data that you volunteer
                          on forms which you submit to us and in emails that you
                          send to us. In addition, we automatically gather
                          details of browser types and IP addresses of the users
                          who visit our site. We do not release this information
                    ...
                    <li>
                      ...
                      <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                        <li>
                          ...
                          initiate payment, authenticate access to account and
                          communicate users to accounts.
                        </li>
                        <li>
                          sing device, location, profile, usage, and other data
                          to prevent, detect, and combat fraud or unsafe
                          activities.
                        </li>
                        <li>
                        ...
                        <li>
                          To conduct data analysis, testing, and research; and
                          to monitor and analyse usage and activity trends.
                        </li>
                        <li>
                          Enabling accessibility features that make it easier
                          for users with disabilities to use our services.
                        </li>
                        <li>
                          Testing, research, analysis, product development, and
                          machine learning to improve the user experience.{" "}
                        </li>
                        <li>
                          To improve and enhance the safety and security of our
                          services.
                        </li>
                        <li>
                          To improve our capacity to prevent the use of our
                          services for illegal or improper purposes, develop new
                          features and products, and facilitate insurance and
                          finance solutions in connection with our services.
                        </li>
                        <li>Enabling communications between users.</li>
                        <li>
                          Legal proceedings and requirements. We may use the
                          personal data we collect to investigate or address
                          claims or disputes relating to use of Amarae Services,
                          or as otherwise allowed by applicable law, or as
                        ...
                        <li>
                          ...
                          engaged in fraud or activities that may otherwise harm
                          Amarae.
                        </li>
                        <li>
                          Managing risk, fraud and abuse of our services and you
                ...
                <li id="how-you-can-withdraw-consent">
                  ...
                  <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                    <li>
                      ...
                      you may change your mind and withdraw consent at any time
                      by contacting us but that will not affect the lawfulness
                ...
                <li id="cookies">
                  ...
                  <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                    <li>
                      ...
                      thereby helping us to improve your experience with using
                      our Site. We intend to use cookies for a variety of
                      reasons detailed below:
                      <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                        <li>To track site usage and browsing behaviour;</li>
                        <li>
                          To allow you to sign in to your account and navigate
                          through the website;
                        </li>
                        <li>
                          To tailor our website’s functionality to you
                          personally by letting us remember your preferences;
                        </li>
                        <li>To improve how our website performs;</li>
                        <li>
                          To allow third parties to provide services to our
                          website;
                        </li>
                        <li>
                          To monitor the effectiveness of our promotions and
                          advertising; and
                        </li>
                        <li>
                          To mitigate risk, enhance security and help prevent
                          fraud.
                        </li>
                      </ul>
                    </li>
                    ...
                    <li>
                      ...
                      or you delete them. Persistent cookies allow us to
                      remember things about you when you visit our website
                      again.
                    </li>
                    <li>
                      When you submit data through a form, cookies may be set to
                      remember your user details for future correspondence. In
                      order to provide you with a great experience on the Sites,
                      we provide the functionality to set your preferences for
                      how the Sites run when you use it. In order to remember
                      your preferences, we may need to set cookies so that this
                      information can be called whenever you interact with a
                      page that is affected by your preferences.
                    </li>
                    <li>
                      We may also use local shared objects, commonly referred to
                      as "Flash Cookies," to help ensure that your account
                      security is not compromised, to spot irregularities in
                      behaviour to help prevent fraud, and to support our sites
                      and services. We may use cookies to collect information
                      about your computer or other access device to mitigate
                      risk, help prevent fraud, and promote trust and safety.
                    </li>
                    <li>
                      We shall encode our cookies so that only we can interpret
                      the information stored in them. You are free to decline
                      our cookies if your browser or browser add-on permits, but
                      doing so may interfere with your use of Amarae Services.
                      Disabling cookies will usually result in also disabling
                      certain functionality and features of the Amarae Site. The
                      help section of most browsers or browser add-ons provides
                    ...
                    <li>
                      ...
                      <p>
                        ...
                        Administered by: Us Purpose: These Cookies allow us to
                        remember choices You make when You use the Website, such
                        as remembering your login details or language
                        preference. The purpose of these Cookies is to provide
                        You with a more personal experience and to avoid You
                        having to re-enter your preferences every time You use
                        the Website.
                      </p>
                    </li>
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          ...
                          trusted third parties. We may use authorised
                          third-party providers to help us with various aspects
                          of our business, such as website operations, services,
                          applications, advertising, support tools and to serve
                          you relevant content.
                        </li>
                        <li>
                          These service providers may place cookies on your
                          device (third-party cookies) or make use of similar
                          tracking technologies such as web beacons. No
                          personally identifiable information is stored in
                          third-party cookies. The information reported to us is
                          aggregated and anonymous. We use this information to
                          understand, for example, the effectiveness of our
                          advertising and marketing. Web beacons are small
                          graphic images (also known as “pixel tags” or “clear
                          GIFs”) which may be used to collect and store
                          information about visits to our website (such as which
                          pages you viewed and how long you spent on the
                          website) and communication efficiency (such as the
                          email delivery and open rates). Where necessary, the
                          information gathered by web beacons may be tied to
                          your personal data strictly for the purposes set out
                          herein.
                        </li>
                        <li>
                          The Amarae Site may contain links to third-party
                          websites and applications of interest, including
                          advertisements and external services, that are not
                          affiliated with us. Once you have used these links to
                          leave the Amarae Site, any information you provide to
                          these third parties is not covered by this Policy, and
                          we cannot guarantee the safety and privacy of your
                          information.
                        </li>
                        <li>
                          Before visiting and providing any information to any
                          third-party websites, you should inform yourself of
                          the privacy policies and practices (if any) of the
                          third party responsible for that website, and should
                          take those steps necessary to, in your discretion,
                          ...
                          other sites, services or applications that may be
                          linked to or from the Amarae Site.
                        </li>
                        <li>
                          Cookies in no way gives us access to your computer or
                          any information about you, other than the data you
                          choose to share with us. Certain aspects and features
                          of our services are only available through the use of
                          cookies. By signing up for an account with Amarae, or
                          continuing to use our website, you agree to our use of
                          cookies as set out in this policy. You may decline our
                          cookies if your browser or browser add-on permits, but
                          doing so may interfere with your use of Amarae
                          services. For information on how to delete or reject
                          cookies, you can consult the "Help" function within
                          your browser, or visit www.allaboutcookies.org, where
                          you will also find more information data about cookies
                          generally.
                        </li>
                      </ul>
                    </li>
                ...
                <li id="data-sharing">
                  ...
                  <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                    <li>
                      Some of our products, Services, and features require that
                      we share your data with other users or at a user’s
                      request. We may also share your data with our affiliates,
                    ...
                    <li>
                      ...
                      <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                        <li>
                          With other companies that provide services to us: We
                          may share personal data with third-party service
                          providers that perform services and functions at our
                          direction and on our behalf. These third-party service
                          providers may, for example, provide you with services,
                          verify your identity, assist in processing
                          transactions, send you advertisements for our products
                          and services, or provide customer support.
                        </li>
                        <li>
                          With other financial institutions: We may share
                          personal data with other financial institutions that
                          we have partnered with to only offer Amarae services,
                          unless you have given consent for other uses. We may
                          also share personal data to process transactions and
                          keep your financial information up to date.
                        </li>
                        <li>
                          With the other parties to transactions when you use
                          the services, such as other users and their service
                          providers: The information might include:
                          <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                            <li>
                              Personal Data and account information necessary to
                              facilitate a transaction; and
                            </li>
                            <li>
                              Personal Data to help other participant(s) resolve
                              disputes and detect and prevent fraud.
                            </li>
                          </ul>
                        </li>
                        <li>
                          At the user’s request: This includes sharing data
                          with:
                          <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                            <li>other people at the user’s request.</li>
                            <li>
                              with the general public: Questions or comments
                              from users submitted through public forums such as
                              Amarae website and social media pages may be
                              viewable by the public, including any personal
                              data included in the questions or comments
                              submitted by a user.
                            </li>
                          </ul>
                        </li>
                        <li>
                          With our professional advisers, consultants and other
                          similar services.
                        </li>
                        <li>
                          For business transfers: We may share or transfer
                          user’s personal information in connection with, or
                          during negotiations of, any merger, sale of company
                          assets, financing, or acquisition of all or a portion
                          of our business to another company.
                        </li>
                        <li>
                          With Affiliates: We may share user’s information with
                          our affiliates, in which case we will require those
                          affiliates to any subsidiaries, joint venture partners
                          or other companies that we control or that are under
                          common control with us.
                        </li>
                        <li>
                          With business partners: We may share user’s
                          information with any business partners to offer you
                          certain products, services or promotions.
                        </li>
                        <li>
                          For legal reasons or in the event of a dispute: We may
                          share your personal data if we believe it is required
                          by applicable law, regulation, operating license or
                          agreement, legal process or governmental request, or
                          where the disclosure is otherwise appropriate due to
                          safety or similar concerns. This includes sharing
                          personal data with law enforcement officials, public
                          health officials, other government authorities, or
                          other third parties as necessary to enforce our Terms
                          of Service, user agreements, or other policies; to
                          protect our rights or property or the rights, safety,
                          or property of others; or in the event of a claim or
                          dispute relating to the use of our services. If you
                          use another person’s credit card, we may be required
                          by law to share your personal data, including trip or
                          order information, with the owner of that credit card.
                          This also includes sharing personal data with others
                        ...
                        <li>
                          With user’s consent: We may share a user’s personal
                          data other than as described in this Policy if we
                          notify the user and they consent to the sharing.
                        </li>
                      </ul>
                    </li>
                  </ul>
                ...
                <li id="data-security">
                  ...
                  <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                    <li>
                      Amarae places great importance on ensuring the security of
                      your personal data. All information you provide to us is
                      stored on our secure servers. Where we have given you/or
                      where you have chosen a password that enables you to
                      access our app or certain parts of our Sites, you are
                    ...
                    <li>
                      ...
                      procedures and security features to try to prevent your
                      personal data from being accidentally lost, used or
                      accessed in an unauthorised way.{" "}
                    </li>
                    <li>
                      We have put in place procedures to deal with any suspected
                      personal data breach and will notify you and any
                      applicable regulator when we are legally required to do
                      so.
                    </li>
                  </ul>
                </li>
                ...
                <li id="data-retention">
                  ...
                  <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                    <li>
                      ...
                      necessary and relevant for our operations. In addition, we
                      may retain personal information from closed accounts to
                      comply with national laws, prevent fraud, collect any fees
                      owed, resolve disputes, troubleshoot problems, assist with
                      any investigation, enforce our Terms of Use and take other
                      actions permitted or required by applicable national laws.
                    </li>
                    <li>
                ...
                <li id="user-legal-rights">
                  ...
                  <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                    ...
                    <li>
                      ...
                      good reason for us to continue to process it. You also
                      ...
                      processed your data unlawfully or where we are required to
                      erase your personal data to comply with local law. Note,
                    ...
                    <li>
                      ...
                      rights and freedoms. You also have the right to object
                    ...
                    <li>
                      ...
                      <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                        ...
                        <li>
                          ...
                          to verify whether we have overriding legitimate
                          grounds to use it.
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      provided consent for us to use or we used the information
                ...
                <li id="marketing-opt-out">
                  ...
                  <p>
                    ...
                    emails and other messages from Amarae by following the
                ...
                <li id="children-privacy">
                  ...
                  <p>
                    Amarae Service does not address anyone under the age of 16.
                ...
                <li id="scope">
                  ...
                  <p>
                    ...
                    services and products using the Amarae Site or App..
                  </p>
                </li>
              </ol>
