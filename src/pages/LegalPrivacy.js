          ...
          <div className="md:grid md:grid-cols-3 flex flex-col gap-4">
            ...
            <article className="md:col-span-2 flex flex-col leading-relaxed gap-4 lg:px-8">
              ...
              <ol className="list-decimal flex flex-col gap-2 list-inside">
                    ...
                    <li>
                      ...
                      <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                        ...
                        <li>
                          ...
                          you use the AMARAÉ Services. If you do not use AMARAÉ,
                  ...
                  <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                    ...
                    <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                      <li>
                        ...
                        signing up for an AMARAÉ account or filling in forms on
                        the App, AMARAÉ Site and the Services Sites, or by
                    ...
                    <li>
                      ...
                      <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                        ...
                        <li>
                          If you create an account or use the AMARAÉ Services,
                          we may collect the following types of information:
                        </li>
                        <li>
                          When you use AMARAÉ, we collect information about your
                        ...
                        <li>
                          ...
                          authorising AMARAÉ to have access to this information,
                          you agree that AMARAÉ may collect, store, and use this
                          information in accordance with this Privacy Policy.
                        </li>
                        <li>
                          Finally, we may collect additional information you may
                          disclose to our customer support team.
                        </li>
                      </ul>
                    </li>
                  </ul>
                  ...
                  <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                    ...
                    <li>
                      ...
                      <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                        ...
                        <li>
                          Using device, location, profile, usage, and other data
                        ...
                        <li>
                          ...
                          claims or disputes relating to use of AMARAÉ Services,
                ...
                <li id="changes-to-this-policy">
                  <strong>Changes to this Policy</strong>
                  <p>
                    We may change this Policy from time to time in order to
                    reflect changes in the law and/or our privacy practices and
                    if it does, these changes will be posted on this page and
                    when you next start the App, the new policy may be displayed
                    on-screen and you may be required to read and accept the
                    changes to continue your use of the App or continue with the
                    Services on the Services Sites.
                  </p>
                </li>
                ...
                <li id="cookies">
                  ...
                  <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                    ...
                    <li>
                      ...
                      doing so may interfere with your use of AMARAÉ Services.
                      Disabling cookies will usually result in also disabling
                      certain functionality and features of the AMARAÉ Site. The
                    ...
                    <li>
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          leave the AMARAÉ Site, any information you provide to
                        ...
                        <li>
                          ...
                          cookies. By signing up for an account with AMARAÉ, or
                          ...
                          doing so may interfere with your use of AMARAÉ
                    ...
                    <li>
                      ...
                      <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                        ...
                        <li>
                          ...
                          we have partnered with to only offer AMARAÉ services,
                        ...
                        <li>
                          ...
                          <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                            ...
                            <li>
                              ...
                              AMARAÉ website and social media pages may be
                ...
                <li id="data-security">
                  ...
                  <ul className="list-disc flex flex-col gap-2 list-outside pl-8">
                    <li>
                      AMARAÉ places great importance on ensuring the security of
                ...
                <li id="online-payment-methods">
                  ...
                  <p>
                    ...
                    payment gateways such as credit cards (Mastercard, Visa etc)
                    or Wallet. AMARAÉ does not itself support these payment
                    methods, or claim to be in partnership with them. Also,
                    services provided by AMARAÉ are not authorised, approved,
                    endorsed or sponsored by any the payment methods we use or
                    their respective trademark owners. Payment method listings
                    are visible on the AMARAÉ website for informative purposes
                    only. Trademarks which might appear visible on the AMARAÉ
                    website, belong to the respective trademark owners alone.
                  </p>
                </li>
                ...
                <p>
                  ...
                  practices, or your dealing with our Sites, please contact us
                  at{" "}
                  <a
                    className="hover:text-rebel-ruby-100 underline transition-colors"
